...
for index, col, thresh in [(1, 'mediumaquamarine', ("dashed", 54.92)), (6, 'green', ("dashed", 54.92))]:  # , (1, 'steelblue')
    ...
    boxplot = ax.boxplot(list(df_exp['delta']), positions=[boxplot_position], patch_artist=True, widths=0.36)
