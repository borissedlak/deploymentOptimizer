...
utils.train_to_BN(df_anomaly, "Anomaly", export_file="model_anomaly.xml")
...
utils.train_to_BN(df_weather, "Weather", export_file="model_weather.xml")
...
utils.train_to_BN(df_cloud, "CloudDB", export_file="model_cloud.xml")
